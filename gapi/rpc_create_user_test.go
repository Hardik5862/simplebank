...
import (
	...
	mockdb "github.com/Hardik5862/simplebank/db/mock"
	...
	mockwk "github.com/Hardik5862/simplebank/worker/mock"
...
func (expected eqCreateUserTxParamsMatcher) Matches(x any) bool {
	...
	err := util.VerifyPassword(expected.password, actualArg.HashedPassword)
	if err != nil {
		return false
	}
...
func (e eqCreateUserTxParamsMatcher) String() string {
	return fmt.Sprintf("macthes arg %v and %v", e.arg, e.password)
}

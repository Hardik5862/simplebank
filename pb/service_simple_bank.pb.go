...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xa3\x04\n" +
	"\n" +
	"Simplebank\x12\x83\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"F\x92A)\x12\x0fCreate new user\x1a\x16API to create new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12u\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\";\x92A\x1f\x12\n" +
	"Login user\x1a\x11API to login user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x84\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"G\x92A*\x12\vUpdate user\x1a\x1bAPI to update existing user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x90\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"P\x92A5\x12\fVerify email\x1a%API to verify the users email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x81\x01\x92AY\x12W\n" +
	"\x0fSimple Bank API\"?\n" +
	"\rHardik Sachan\x12\x17https://hardiksachan.in\x1a\x15hardik0casr@gmail.com2\x031.0Z#github.com/Hardik5862/simplebank/pbb\x06proto3"
